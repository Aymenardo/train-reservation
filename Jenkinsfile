       ...
       stage('Deploy to Nexus') {
        ...
        stage('Build Docker Image') {
            steps {
                ...
                bat "curl -u admin:ardouni2003 -O http://localhost:8081/repository/train-reservation-releases/com/aymenardo/train-reservation/${ARTIFACT_VERSION}/train-reservation-${ARTIFACT_VERSION}.war"
